...
subtitle: |
  <div style="text-align: center;"><strong>Análisis de datos climáticos para el cultivo de caña</strong></div>
author: |
...
multiplot_with_blue_scale <- function(mapas_precipitaciones, cols = 4) {
  ...
  for (i in seq_along(mapas_precipitaciones)) {
    ...
    plot(mapas_precipitaciones[[i]], main = paste("Precipitación promedio", meses[i]), col = col, cex.main = 4)
  }
}
```
...
https://github.com/JuanRaigoso/An-lisis-de-Datos-Geogr-ficos-y-Espaciales/blob/main/Dato%20Clima%20Ca%C3%B1a%20de%20Azucar.R

Por favor copiar y pegar el enlace en el navegador.
:::
